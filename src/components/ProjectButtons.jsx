function LiveButton({ link, children}) {
    return (
        <a href={link} className="flex text-sm items-center gap-1 font-medium bg-blue-500 px-2 lg:px-3 py-2 rounded-lg transition-all duration-300 hover:bg-opacity-80">
            {children}
        </a>
    )
}
