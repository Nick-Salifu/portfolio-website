...
function Project() {
    ...
    return (
        <div className="px-8 mx-auto mb-40 max-w-screen-2xl md:px-12" id="Project">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    {projects.slice(0, projectsToShow).map((project) => (
                        <div key={project.id} className="p-5 text-gray-300 bg-slate-900 rounded-lg h-full md:w-full border-[0.5px] border-gray-700 hover:-translate-y-2 transition-all duration-300">
                        <div>
